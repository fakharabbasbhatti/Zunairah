...
const EducationExperience = () => {
  ...
  const education = [
    {
      title: "Intermediate",
      period: "2022 - 2024",
      institution: "Govt Girls High School Sahuka",
  ...
  return (
    <Fragment>
      <section
        id="resume"
        className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden"
      >
        {/* Background circles */}
